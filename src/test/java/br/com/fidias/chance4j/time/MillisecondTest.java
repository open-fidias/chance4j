 ...
 * @author atila
 */
public class MillisecondTest extends AbstractChanceTesting {
    
    private int millisecond;
    
    @Test
    public void randomMillisecond() {
        for (int i = 0; i < 1000; i++) {
            millisecond = chance.millisecond();
            assertTrue("random millisecond", millisecond >= Millisecond.MIN
                    && millisecond <= Millisecond.MAX);
        }
    }
}
